/**
 * Import Pump Comparison Data - 23 Dimensions
 * Populates pump_comparison_data table with comprehensive pump details
 * Source: Pump data.pdf (October 3, 2025)
 */
...
// 23 Dimensions Data - Structured from PDF
    ...
    for (const dimension of ALL_DIMENSIONS) {
      ...
      const query = `
        ...
        ON DUPLICATE KEY UPDATE
          ...
          importance_scale = VALUES(importance_scale),
          category = VALUES(category),
          display_order = VALUES(display_order),
          pump_details = VALUES(pump_details),
      ...
      console.log(`✓ Imported dimension #${dimension_number}: ${dimension_name}`);
    }

    console.log('\n✓ All 23 dimensions imported successfully!');
    console.log(`Total dimensions: ${ALL_DIMENSIONS.length}`);

  } catch (error) {
    console.error('✗ Error importing pump comparison data:', error);
    throw error;
  } finally {
    if (connection) {
