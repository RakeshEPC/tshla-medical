import{u as S,m as T,r as o,b as g,j as e}from"./index-CFDQeSWK.js";import{w as C}from"./weightLossProfile.service-DOqGLedQ.js";import{patientService as d}from"./patient.service-Cq6NQU3g.js";function W(){const c=S();T();const[l,x]=o.useState(null),[t,u]=o.useState(null),[p,b]=o.useState(!0),[h,y]=o.useState(!1);o.useEffect(()=>{j()},[]);const j=async()=>{try{const s=d.getCurrentPatient();if(!s){c("/patient-login");return}const a=C.getProfile(s.internalId);if(!a){c("/weightloss/onboarding");return}x(a);const r=await v(a);u(r),N(s.internalId,r)}catch{g("WeightLossOnboardingSummary","Error message",{})}finally{b(!1)}},v=async s=>{const a=`
...
//# sourceMappingURL=WeightLossOnboardingSummary-Dh22_drG.js.map
